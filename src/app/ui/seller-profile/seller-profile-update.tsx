      ...
      <div className={styles['seller-wrapper']}>
        <section className={styles['near-max-width']}>
          ...
          <form action={formAction}>
            <div className={`${styles['update-details']} ${styles['pad-bottom']}`}>
                <label htmlFor="first_name">First Name</label>
                <input type="text" id="first_name" name="first_name" defaultValue={seller.first_name} required/>

                <label htmlFor="last_name">Last Name</label>
                <input type="text" id="last_name" name="last_name" defaultValue={seller.last_name} required/>

                <label htmlFor="description">Biography</label>
                <textarea id="description" name="description" defaultValue={seller.description} required></textarea>

                <label htmlFor="location">Location</label>
                <input type="text" id="location" name="location" defaultValue={seller.location} required/>
            </div>
        ...
        <section className={`${styles['near-max-width']} ${styles['seller-pic']}`}>
